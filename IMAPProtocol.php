...
class Net_IMAPProtocol
{
     ...
     * @var array
     */
    var $supportedAuthMethods = array('DIGEST-MD5', 'CRAM-MD5', 'LOGIN','XOAUTH2'); //databird adding XOAUTH2
...
*/
	...
	/**
     * Authenticates the user using the OAUTH method.
	 * Added by databird sàrl
     *
     * @param string $uid   The userid to authenticate as, format [email|tenantId|clientId].
     * @param string $pwd   The password to authenticate with.
     * @param string $cmdid The cmdID.
     *
     * @return array Returns an array containing the response
